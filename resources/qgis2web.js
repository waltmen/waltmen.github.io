...
var map = new ol.Map({
    ...
    var searchLayer = new ol.SearchLayer({
      layer: lyr_2016_VIC_SEIFA_SA1_1,
      colName: 'SEIFA_SA1_VIC_State_Percentile',
      zoom: 10,
      collapsed: true,
      map: map
    });
...
map.getView().fit([16090783.033348, -4580199.821965, 16180378.787965, -4520834.382600], map.getSize());
